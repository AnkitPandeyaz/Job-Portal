        ...
        <form onSubmit={handleSubmit(onSubmit)} className='space-y-5'>
          ...
          <div className='flex flex-col lg:flex-row item-center justify-between gap-8'>
            <div className='lg:w-1/2 w-full'>
              ...
              <input type="text" defaultValue={"Web Developer"} {...register("jobTitle", { required: true })} className='block w-full flex-1 border-1 bg-white py-1.5 pl-3 text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-sm sm:leading-6' />
          ...
          <div className='flex flex-col lg:flex-row item-center justify-between gap-8'>
            <div className='lg:w-1/2 w-full'>
              ...
              <input type="text" placeholder='$20k' {...register("minPrice", { required: true })} className='block w-full flex-1 border-1 bg-white py-1.5 pl-3 text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-sm sm:leading-6' />
              {errors.minPrice && <span className="text-red-500">Minimum Salary is required</span>}
            </div>
            <div className='lg:w-1/2 w-full'>
              <label className='block mb-2 text-lg'>Maximum Salary</label>
              <input type="text" placeholder=' $100k' {...register("maxPrice", { required: true })} className='create-job-input' />
          ...
          <div className='flex flex-col lg:flex-row item-center justify-between gap-8'>
            ...
            <div className='lg:w-1/2 w-full'>
              ...
              <input type="text" placeholder='Ex: New Delhi' {...register("jobLocation", { required: true })} className='create-job-input' />
          ...
          <div className='flex flex-col lg:flex-row item-center justify-between gap-8'>
            <div className='lg:w-1/2 w-full'>
              ...
              <input type="date" placeholder='2024/02/21' {...register("postingDate", { required: true })} className='create-job-input' />
          ...
          <div className='flex flex-col lg:flex-row item-center justify-between gap-8'>
            <div className='lg:w-1/2 w-full'>
              ...
              <input type="url" placeholder='Paste your company logo URL here' {...register("companyLogo")} className='create-job-input' />
            </div>
            <div className='lg:w-1/2 w-full'>
          ...
          <div className='w-full'>
            ...
            <textarea className='w-full pl-3 py-1.5 focus:outline-none' rows={6} placeholder='Job Description - Write here.' {...register("description", { required: true })} />
          ...
          <div className='w-full'>
            ...
            <input type='email' name='email' id='email' placeholder='madebyAnkitPandey@gmail.com' {...register("postedBy", { required: true })} className='create-job-input' />
